...
public class QuestionList
{
     ...
     *  perguntas. Vale destacar que esse caminho começa no diretório do
     *  projeto, na pasta onde o Makefile está presente. Dessa forma, 
     *  idealmente, a string filepath começa com "data/" e termina com ".json".
	 */
	...
	public int getSize ()
	{
		if (null == this.questionList) return 0;
